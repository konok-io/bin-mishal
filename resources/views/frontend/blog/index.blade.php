                ...
                @else
                    ...
                    <article class="blog-card mb-4">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="{{ locale_route('blog.detail', $post->slug) }}" class="btn btn-outline-success">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <a href="{{ locale_route('blog') }}" class="text-decoration-none">
                                    @lang('All Posts')
                                </a>
                            </li>
                            @foreach($categories as $category)
                            <li class="list-group-item">
                                <a href="{{ locale_route('blog', ['category' => $category->slug]) }}" class="text-decoration-none">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            @endif
                            <div>
                                <a href="{{ locale_route('blog.detail', $featured->slug) }}" class="text-decoration-none fw-bold">
