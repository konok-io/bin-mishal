        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="article-tags mt-5">
                    ...
                    <a href="{{ locale_route('blog', ['tag' => $tag->slug]) }}" class="badge bg-secondary text-decoration-none">
                        {{ $tag->name }}
                    </a>
                    @endforeach
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <h6 class="card-title">
                                        <a href="{{ locale_route('blog.detail', $related->slug) }}" class="text-decoration-none text-dark">
