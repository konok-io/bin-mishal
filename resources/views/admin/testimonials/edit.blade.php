    ...
    <div class="card-body">
        <form action="{{ route('testimonials.update', $testimonial->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name_bn" name="name_bn" value="{{ old('name_bn', $testimonial->name_bn) }}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name_ar" name="name_ar" value="{{ old('name_ar', $testimonial->name_ar) }}" dir="rtl">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="designation_bn" name="designation_bn" value="{{ old('designation_bn', $testimonial->designation_bn) }}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="designation_ar" name="designation_ar" value="{{ old('designation_ar', $testimonial->designation_ar) }}" dir="rtl">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="company_bn" name="company_bn" value="{{ old('company_bn', $testimonial->company_bn) }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="company_ar" class="form-label">Company (Arabic)</label>
                        <input type="text" class="form-control" id="company_ar" name="company_ar" value="{{ old('company_ar', $testimonial->company_ar) }}" dir="rtl">
                    </div>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="quote_bn" name="quote_bn" rows="3">{{ old('quote_bn', $testimonial->quote_bn) }}</textarea>
            </div>
            <div class="mb-3">
                <label for="quote_ar" class="form-label">Quote (Arabic)</label>
                <textarea class="form-control" id="quote_ar" name="quote_ar" rows="3" dir="rtl">{{ old('quote_ar', $testimonial->quote_ar) }}</textarea>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="avatar" class="form-label">Avatar URL</label>
                        <input type="text" class="form-control" id="avatar" name="avatar" value="{{ old('avatar', $testimonial->avatar) }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="service_type" class="form-label">Service Type</label>
                        <input type="text" class="form-control" id="service_type" name="service_type" value="{{ old('service_type', $testimonial->service_type) }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="sort_order" class="form-label">Sort Order</label>
                        <input type="number" class="form-control" id="sort_order" name="sort_order" value="{{ old('sort_order', $testimonial->sort_order ?? 0) }}">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('testimonials.index') }}" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
