...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="{{ route('admin.chart-of-accounts.initialize') }}" class="btn btn-outline-primary" onclick="return confirm('Initialize system accounts?')">
...
<div class="card">
    <div class="card-header">
        <form action="{{ route('admin.chart-of-accounts.index') }}" method="GET" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                ...
                <a href="{{ route('admin.chart-of-accounts.index') }}" class="btn btn-outline-secondary"><i class="bi bi-x-circle"></i></a>
            </div>
        </form>
    </div>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.chart-of-accounts.show', $account->id) }}" class="btn btn-sm btn-info">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{ route('admin.chart-of-accounts.edit', $account->id) }}" class="btn btn-sm btn-warning">
                                <i class="bi bi-pencil"></i>
                            </a>
                            @if(!$account->is_system)
                                <form action="{{ route('admin.chart-of-accounts.destroy', $account->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
