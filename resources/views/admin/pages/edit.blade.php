    ...
    <div class="card-body">
        <form action="{{ route('pages.update', $page->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title.en') is-invalid @enderror" id="title_en" name="title[en]" value="{{ old('title.en', $page->title['en'] ?? '') }}" required>
                        @error('title.en')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title_bn" name="title[bn]" value="{{ old('title.bn', $page->title['bn'] ?? '') }}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="slug_en" name="slug[en]" value="{{ old('slug.en', $page->slug['en'] ?? '') }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="slug_bn" class="form-label">Slug (Bengali)</label>
                        <input type="text" class="form-control" id="slug_bn" name="slug[bn]" value="{{ old('slug.bn', $page->slug['bn'] ?? '') }}">
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="parent_id" name="parent_id">
                            ...
                            @foreach($parentPages as $parent)
                                <option value="{{ $parent->id }}" {{ old('parent_id', $page->parent_id) == $parent->id ? 'selected' : '' }}>{{ $parent->title['en'] ?? 'Untitled' }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-check mt-4">
                        <input class="form-check-input" type="checkbox" id="show_header" name="show_header" value="1" {{ old('show_header', $page->show_header) ? 'checked' : '' }}>
                        <label class="form-check-label" for="show_header">Show Header</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-check mt-4">
                        <input class="form-check-input" type="checkbox" id="show_footer" name="show_footer" value="1" {{ old('show_footer', $page->show_footer) ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="order" name="order" value="{{ old('order', $page->order ?? 0) }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
