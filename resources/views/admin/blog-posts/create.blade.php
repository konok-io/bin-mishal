            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="excerpt_ar" name="excerpt_ar" rows="2">{{ old('excerpt_ar') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="content_bn" name="content_bn" rows="5">{{ old('content_bn') }}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="content_ar" class="form-label">Content (Arabic)</label>
                        <textarea class="form-control" id="content_ar" name="content_ar" rows="5">{{ old('content_ar') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="row">
