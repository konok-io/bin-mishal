...
<div class="card">
    <div class="card-header">
        <form action="{{ route('biometric-devices.index') }}" method="GET" class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('biometric-devices.index') }}" class="btn btn-outline-secondary"><i class="bi bi-x-circle"></i> Clear</a>
            </div>
        </form>
    </div>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('biometric-devices.show', $device->id) }}" class="btn btn-sm btn-info">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{ route('biometric-devices.edit', $device->id) }}" class="btn btn-sm btn-warning">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form action="{{ route('biometric-devices.destroy', $device->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
