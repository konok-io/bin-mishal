...
<div class="admin-page-header d-flex justify-content-between align-items-center">
    <h1 class="h4 mb-0">Add SEO Setting</h1>
        ...
        <form action="{{ route('admin.seo-settings.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('og_description') is-invalid @enderror" id="og_description" name="og_description" rows="2" maxlength="500">{{ old('og_description') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('og_image') is-invalid @enderror" id="og_image" name="og_image" value="{{ old('og_image') }}">
                        @error('og_image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-circle"></i> Create SEO Setting
                </button>
