    ...
    <div class="card-body">
        <form action="{{ route('translations.update', $translation->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="value_bn" name="value_bn" rows="3">{{ old('value_bn', $translation->value_bn) }}</textarea>
            </div>
            <div class="mb-3">
                <label for="value_ar" class="form-label">Arabic Value</label>
                <textarea class="form-control" id="value_ar" name="value_ar" rows="3" dir="rtl">{{ old('value_ar', $translation->value_ar) }}</textarea>
            </div>
            <div class="mb-3">
                <label for="source" class="form-label">Source</label>
                <input type="text" class="form-control" id="source" name="source" value="{{ old('source', $translation->source) }}">
            </div>
            <div class="mt-4">
