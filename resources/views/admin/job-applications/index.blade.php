...
<div class="card">
    <div class="card-header">
        <form action="{{ route('admin.job-applications.index') }}" method="GET" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-4">
                ...
                <a href="{{ route('admin.job-applications.index') }}" class="btn btn-outline-secondary"><i class="bi bi-x-circle"></i></a>
            </div>
        </form>
    </div>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.job-applications.show', $application->id) }}" class="btn btn-sm btn-info">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{ route('admin.job-applications.edit', $application->id) }}" class="btn btn-sm btn-warning">
