    ...
    <div class="card-body">
        <form action="{{ route('admin.faqs.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="question_bn" name="question_bn" value="{{ old('question_bn') }}">
            </div>
            <div class="mb-3">
                <label for="question_ar" class="form-label">Question (Arabic)</label>
                <input type="text" class="form-control" id="question_ar" name="question_ar" value="{{ old('question_ar') }}" dir="rtl">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="answer_bn" name="answer_bn" rows="3">{{ old('answer_bn') }}</textarea>
            </div>
            <div class="mb-3">
                <label for="answer_ar" class="form-label">Answer (Arabic)</label>
                <textarea class="form-control" id="answer_ar" name="answer_ar" rows="3" dir="rtl">{{ old('answer_ar') }}</textarea>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
