...
class HomepageSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Trust Badges
        $trustBadges = [
            ['name' => 'IATA Certified', 'name_bn' => 'IATA সার্টিফাইড', 'name_ar' => 'معتمد من IATA', 'image_url' => 'https://via.placeholder.com/100x50/2F378A/ffffff?text=IATA', 'link' => '#'],
            ['name' => 'Saudi Tourism', 'name_bn' => 'সৌদি পর্যটন', 'name_ar' => 'السياحة السعودية', 'image_url' => 'https://via.placeholder.com/100x50/E25A24/ffffff?text=SAT', 'link' => '#'],
            ['name' => 'ATAB Member', 'name_bn' => 'ATAB সদস্য', 'name_ar' => 'عضو ATAB', 'image_url' => 'https://via.placeholder.com/100x50/1F2937/ffffff?text=ATAB', 'link' => '#'],
            ['name' => 'Secure Payment', 'name_bn' => 'নিরাপদ পেমেন্ট', 'name_ar' => 'دفع آمن', 'image_url' => 'https://via.placeholder.com/100x50/E25A24/ffffff?text=SSL', 'link' => '#'],
        ];
